...
export default function VendorProducts({ navigation, route }) {
  ...
  useEffect(() => {
    ...
    // Auto open add modal if navigated with action
  ...
  const validateForm = () => {
    const errs = {};
    if (!form.name.trim())
      errs.name = 'Product name required.';
        ...
        <View style={styles.productInfo}>
          ...
          <View style={styles.productMeta}>
            ...
            <Text
              style={[
                styles.stockText,
                isOutOfStock && styles.stockDanger,
      ...
      <View style={styles.modalContainer}>
        ...
        >
          ...
          <TextInput
            style={[
              styles.fieldInput,
              formErrors.name && styles.fieldInputError,
            ]}
            value={form.name}
