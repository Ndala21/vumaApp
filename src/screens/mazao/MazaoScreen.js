...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#0E3B2C', paddingTop: Platform.OS === 'ios' ? 50 : SPACING.base, paddingBottom: SPACING.base, paddingHorizontal: SPACING.base },
  ...
  sellBtn: { backgroundColor: '#0E9F6E', borderRadius: RADIUS.lg, paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs },
  ...
  sellingFilterRow: { flexDirection: 'row', gap: SPACING.sm, paddingHorizontal: SPACING.base, paddingVertical: SPACING.sm, backgroundColor: '#E3F9F0' },
  sellingChip: { paddingHorizontal: SPACING.base, paddingVertical: SPACING.xs + 2, borderRadius: RADIUS.full, borderWidth: 1.5, borderColor: '#0E9F6E', backgroundColor: 'white' },
  sellingChipActive: { backgroundColor: '#0E3B2C', borderColor: '#0E3B2C' },
  sellingChipText: { fontSize: FONTS.sm, color: '#0E3B2C', fontWeight: FONTS.semiBold },
  sellingChipTextActive: { color: 'white' },
  filterRow: { backgroundColor: '#E3F9F0', maxHeight: 48, borderBottomWidth: 1, borderBottomColor: '#BEEDD9' },
  filterContent: { paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs, gap: SPACING.xs },
  filterChip: { paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs + 2, borderRadius: RADIUS.full, borderWidth: 1.5, borderColor: '#0E9F6E', backgroundColor: 'white' },
  filterChipActive: { backgroundColor: '#0E3B2C', borderColor: '#0E3B2C' },
  filterChipText: { fontSize: FONTS.xs, color: '#0E3B2C', fontWeight: FONTS.medium },
  ...
  cardImagePlaceholder: { backgroundColor: '#E3F9F0', alignItems: 'center', justifyContent: 'center' },
  ...
  price: { fontSize: FONTS.base, fontWeight: FONTS.black, color: '#0E3B2C' },
  unit: { fontSize: FONTS.xs, color: COLORS.textMuted },
  wholesaleText: { fontSize: FONTS.xs, color: '#0E9F6E', fontWeight: FONTS.semiBold, marginTop: 2 },
  metaRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 4 },
  metaText: { fontSize: FONTS.xs, color: COLORS.textMuted },
  deliveryBadge: { fontSize: FONTS.xs, color: '#0E3B2C', fontWeight: FONTS.medium },
