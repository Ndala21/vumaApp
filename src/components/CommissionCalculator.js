...
const styles = StyleSheet.create({
  // Badge
  badge: { backgroundColor: COLORS.primaryFade, borderRadius: RADIUS.lg, padding: SPACING.base, borderWidth: 1, borderColor: 'rgba(255,106,0,0.25)' },
  badgeTitle: { fontSize: FONTS.sm, fontWeight: FONTS.bold, color: COLORS.primaryDark, marginBottom: SPACING.sm },
  ...
  badgeDivider: { height: 1, backgroundColor: 'rgba(255,106,0,0.2)', marginVertical: SPACING.sm },
  badgeNetLabel: { fontSize: FONTS.base, fontWeight: FONTS.black, color: COLORS.textPrimary },
  badgeNetValue: { fontSize: FONTS.base, fontWeight: FONTS.black, color: COLORS.success, letterSpacing: FONTS.trackTight },
  ...
  // Card
  card: { backgroundColor: COLORS.surface, borderRadius: RADIUS.xl, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden', ...SHADOWS.xs },
  ...
  breakdownFeeRow: { backgroundColor: COLORS.dangerLight, borderRadius: RADIUS.sm, paddingHorizontal: SPACING.sm, marginHorizontal: -SPACING.sm },
  ...
  breakdownNetValue: { fontSize: FONTS.lg, fontWeight: FONTS.black, color: COLORS.success, letterSpacing: FONTS.trackTight },
  breakdownNote: { fontSize: FONTS.xs, color: COLORS.primary, marginTop: SPACING.sm, textAlign: 'center' },
  // Earnings Card
  earningsCard: { backgroundColor: COLORS.surface, borderRadius: RADIUS.xl, padding: SPACING.base, borderWidth: 1, borderColor: COLORS.border, ...SHADOWS.sm },
  ...
  earningsStatValue: { fontSize: FONTS.base, fontWeight: FONTS.black, color: COLORS.textPrimary, textAlign: 'center', letterSpacing: FONTS.trackTight },
